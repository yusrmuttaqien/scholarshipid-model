...
Output structure:
    ...
    ├── scholarships.csv      # 800 scholarships
...
class Student:
    ...
    # Demographics
    age: int
    current_degree_level: str
    target_degree_level: str

    # Academic Profile
    high_school_track: str
    school_name: str
    ...
    # Achievements
    olympiad_level: str = "none"
    olympiad_subjects: List[str] = field(default_factory=list)
    leadership_experience_count: int = 0
    volunteer_experience_count: int = 0
    competition_wins_count: int = 0

    # Background
    school_tier: str = "unknown"
    family_income_category: str = "middle"
    from_underrepresented_region: bool = False

    # Career Intent
    intended_career_track: str = ""
...
class Scholarship:
    ...
    min_age: int
    max_age: int
    eligible_degree_levels: List[str]
    eligible_high_school_tracks: List[str]
    eligible_fields: List[str]
    preferred_school_tier: str
    ...
    max_family_income_category: str = "high"
